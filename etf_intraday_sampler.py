...
데이터 소스: KIS ETF/ETN 현재가 (FHPST02400000,
GET /uapi/etfetn/v1/quotations/inquire-price) - 응답 output의
stck_prpr(현재가) / nav / dprt(괴리율) 필드 사용 (공식 샘플로 확인됨).
...
레이트리밋: 종목당 0.1s 간격(약 10req/s, KIS 한도 20req/s의 절반) →
100종목 스윕에 ~10초, 1분 주기 내 여유.
